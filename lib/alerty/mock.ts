...
export const demoCommunityPosts: CommunityPost[] = [
  ...
  },
  {
    ...
    authorAvatarUrl: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=96",
    lat: 24.8125,
    lng: -107.388,
    placeLabel: "Las Quintas",
    geoSource: "text_colonia",
    placeNameSource: "Culiacán (X)",
    geocodedFromText: "Las Quintas",
  ...
  },
  {
    ...
    mediaUrl: null,
    authorAvatarUrl: "https://www.google.com/s2/favicons?domain=lineadirectaportal.com&sz=64",
    lat: 24.8057,
    lng: -107.3946,
    placeLabel: "Centro",
    geoSource: "text_colonia",
    placeNameSource: null,
    geocodedFromText: "Centro",
  ...
  {
    id: "demo-rss-mismatch",
    source: "rss",
    externalId: "demo-rss-colonia-mismatch",
    authorHandle: "@LineaDirectaMX",
    authorName: "Línea Directa",
    text: "DEMO — Autoridades atienden reporte en la colonia Adolfo López Mateos; el pin usa la colonia del texto aunque el lugar del medio diga Guadalupe.",
    url: "https://example.com/demo-noticia-lopez-mateos",
    mediaUrl: null,
    authorAvatarUrl: "https://www.google.com/s2/favicons?domain=lineadirectaportal.com&sz=64",
    lat: 24.7848,
    lng: -107.4015,
    placeLabel: "Adolfo López Mateos",
    geoSource: "text_colonia",
    placeNameSource: "Guadalupe",
    geocodedFromText: "Adolfo López Mateos",
    createdAt: new Date(Date.now() - 40 * 60 * 1000).toISOString(),
    fetchedAt: new Date().toISOString(),
    categoryGuess: "alerta",
    isDemo: true,
    trustTier: "news",
  },
];
